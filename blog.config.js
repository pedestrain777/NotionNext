...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'H-', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '北京邮电大学 智能科学与技术专业 本科生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-henna-six-76.vercel.app/', // 网站地址
